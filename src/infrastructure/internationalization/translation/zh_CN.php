...
return array(
    ...
    "No such repository \"%s\"!" => "代码库 \"%s\" 未找到",
    ...
    "Current Value:" => "当前值:",
    "Locked" => "已锁定",
    "Really ignore this setup issue?" => "确定忽略这个问题?",
    "Ignore" => "忽略",
    "Unignore this setup issue?" => "忽略这个问题？",
    "Unignore" => "取消忽略",
    ...
    "This setup issue has been resolved. " => "问题已解决",
    ...
    "Disable Real-Time Notifications" => "禁用实时通知",
    "Daemons" => "Daemons",
    ...
    "Are you sure you want to remove yourself from this conpherence? " => "确认要从此会话中离开？",
    "The conpherence will be inaccessible forever and ever." => "此会话将不可访问。",
    "Someone else in the conpherence can add you back later." => "此会话中的其他参与者可以将你重新添加回会话。",
    ...
    "Loading comment preview..." => "正在载入评论预览...",
    "Changed Files" => "Changed Files",
    "Undo" => "撤销",
    "This file content has been collapsed." => "文件内容已折叠",
    "Open in Editor" => "在编辑器中打开",
    "Show Entire File" => "显示完整文件",
    "Entire File Shown" => "完整文件已显示",
    "Expand File" => "展开文件",
    "Collapse File" => "折叠文件",
    "Browse in Diffusion" => "在 Diffusion(代码浏览器) 中浏览",
    "View Standalone" => "单独查看",
    ...
    "No Branches" => "没有分支",
    "This repository has no branches." => "此代码库没有分支",
    "Branches" => "分支",
    ...
    "Show Search" => "显示搜索",
    "Hide Search" => "隐藏搜索",
    "Search for file names or content in this directory." => "在此文件夹中搜索文件名或文件内容",
    "View History" => "查看历史",
    "Jump to HEAD" => "查看 HEAD 版本",
    ...
    "File Contents" => "文件内容",
    "Show Last Change" => "查看最终改动",
    "Disable Blame" => "禁用 Blame",
    "Enable Blame" => "启用 Blame",
    "Disable Highlighting" => "禁用语法高亮",
    "Enable Highlighting" => "启用语法高亮",
    "Hide %d Lint Message(s)" => "隐藏 %d 个 Lint 信息",
    "Lint not Available" => "Lint 不可用",
    "Show %d Lint Message(s)" => "显示 %d 个 Lint 信息",
    ...
    "Deactivate this repository?" => "禁用此代码库?",
    "Deactivate Repository" => "禁用代码库",
    "Activate Repository?" => "激活代码库?",
    "Activate this repository?" => "激活此代码库?",
    "Activate Repository" => "激活代码库",
    ...
    "Allow Dangerous Changes" => "允许危险的改动",
    "Really want to delete the repository?" => "确认删除此代码库？",
    "Okay" => "好",
    "Edit Encoding" => "编辑字符集",
    "Text Encoding" => "文本字符集",
    "Save Encoding" => "保存字符集",
    ...
    "Activate this repository to begin or resume import." => "激活项目以开始或继续导入",
    ...
    "This repository will be updated soon." => "代码库马上更新完毕",
    "Add Mirror" => "新建镜像",
    "Automatically push changes into other remotes." => "自动 push 改动到其他远程代码库",
    "This repository has no configured mirrors." => "代码库没配置镜像",
    ...
    "You do not have permission to access this repository." => "你没有权限访问此代码库",
    "You must log in to access this repository." => "你必须登录以访问此代码库",
    "This repository is inactive." => "代码库未激活",
    "This repository is read-only over HTTP." => "This repository is read-only over HTTP.",
    "You must log in to push to this repository." => "你必须登录以 Push 代码到此代码库",
    ...
    "You must select a file to upload." => "必须选择一个文件",
    "Drag and Drop:" => "拖拉:",
    "Optional file display name." => "文件显示名词（可选）",
    "Upload" => "上传",
    "To add files, drag and drop them into the comment text area." => "将文件拖到内容编辑框以上传文件。",
    "Close" => "关闭",
    "FILE DETAIL" => "文件详情",
    "You successfully uploaded %d files." => "成功上传了 %d 个文件",
    "You successfully uploaded a file." => "成功上传了 1 个文件",
    ...
    "Help" => "帮助",
    "Close any dialog, including this one." => "关闭所有对话框(包括此对话框)",
    ...
    "Create New..." => "新建...",
    "Show More Applications" => "显示所有应用",
    "Show Fewer Applications" => "折叠部分应用",
    ...
    "Create Another Subtask" => "创建新的子任务",
    "Similar Task" => "相似任务",
    "Empty Task" => "新任务",
    "New task created." => "任务已创建",
    "Close Task" => "关闭任务",
    "Reassign / Claim" => "指派给他人",
    ...
    "Parent Task" => "父任务",
    "CC" => "抄送用户",
    "You can also create tasks by sending an email to: %s" => "你也可以发送邮件到 %s 来创建任务",
    ...
    "Raised Priority" => "提高了优先级",
    "%s changed the title from \"%s\" to \"%s\"." => "%s 将任务名称从 \"%s\" 修改为 \"%s\"",
    "%s edited the task description." => "%s 编辑了任务描述",
    "%s created this task." => "%s 创建了任务",
    "%s reopened this task." => "%s 重新打开了任务",
    "%s closed this task out of spite." => "%s 关闭了任务(拒绝处理)",
    "%s closed this task as a duplicate." => "%s 关闭了任务(重复任务)",
    "%s closed this task as \"%s\"." => "%s 关闭了任务(\"%s\")",
    "%s claimed this task." => "%s 分配了任务",
    "%s placed this task up for grabs." => "%s placed this task up for grabs.",
    "%s assigned this task to %s." => "%s 将任务指派给了 %s",
    "%s reassigned this task from %s to %s." => "%s 将任务指派从 %s 转给了 %s",
    "%s added %d project(s): %s" => "%s 添加了 %d 个项目 %s",
    "%s removed %d project(s): %s" => "%s 移除了 %d 个项目 %s",
    "%s changed project(s), added %d: %s; removed %d: %s" => "%s 添加了 %d 个项目 %s，移除了 %d 个项目 %s",
    "%s changed projects..." => "%s 修改了项目...",
    "%s triaged this task as \"%s\" priority." => "%s 修改优先级为 \"%s\"",
    ...
    "%s triaged %s as \"%s\" priority." => "%s 修改 %s 的优先级为 \"%s\"",
    ...
    "Notification Server Status" => "通知服务器状态",
    "Send Test Notification" => "发送测试通知",
    "This is a test notification, sent at %s." => "这是一条测试通知，发送于 %s.",
    "Notification Server Down" => "通知服务器宕机了",
    "Unable to Connect to Notification Server" => "无法连接到通知服务器",
    "Notification Server Version" => "通知服务器版本",
    "Notification Server Out of Date" => "通知服务器过期了",
    ...
    "Blurb" => "简介",
    "Short blurb about the user." => "此用户的简介",
    ...
    "Page Not Found" => "当前页面未找到",
    "Document Deleted" => "文档已删除",
    "Empty Document" => "空文档",
    "Document Moved" => "文档已移动",
    "This document was moved from %s" => "文档移自 %s",
    "Project Info" => "项目信息",
    "Last Author" => "最后编辑人",
    "Today" => "今天",
    "Yesterday" => "昨天",
    ...
    "Can Edit" => "允许编辑",
    "You do not have permission to edit this object." => "你没有编辑此项目的权限",
    "Can Join" => "允许加入",
    "You do not have permission to join this object." => "你没有加入此项目的权限",
    "Can View" => "允许查看",
    "You do not have permission to view this object." => "你没有查看此项目的权限",
    ...
    "Edit Project" => "编辑项目",
    "Users who can edit a project can always join a project." => "一个用户，在拥有编辑一个项目的权限时，同时拥有加入此项目的权限",
    "Edit Details" => "编辑详情",
    "Edit Picture" => "编辑图片",
    ...
    "Members of a project can always view it." => "项目成员能够查看此项目",
    "Users who can edit a project can always join it." => "一个用户，在拥有编辑一个项目的权限时，同时拥有加入此项目的权限",
    "Backlog" => "Backlog",
    "Users must be able to see a project to see its board." => "Users must be able to see a project to see its board.",
    "%s created this project." => "%s 创建了项目。",
    "%s renamed this project from \"%s\" to \"%s\"." => "%s 将项目名字从 \"%s\" 改为了 \"%s\"。",
    "%s closed this project." => "%s 关闭了项目。",
    "%s reopened this project." => "%s 重新打开了项目。",
    "%s changed project member(s), added %d: %s; removed %d: %s" => "%s 修改了项目成员，添加了 %d 人：%s; 移除了 %d 人：%s",
    "%s joined this project." => "%s 加入了项目。",
    "%s added %d project member(s): %s" => "%s 添加了 %d 个项目成员：%s",
    "%s added %d member(s): %s." => "%s 添加了 %d 个项目成员：%s",
    "%s left this project." => "%s 离开了项目。",
    ...
    "Builtin" => "内置的",
    "No saved queries." => "未找到已保存的查询",
    "No results found for this query." => "未找到结果",
    ...
    "Delete Query" => "删除查询",
    "You must name the query." => "你必须命名此查询",
    "Query Name" => "命名查询",
    "Save Query" => "保存查询",
    ...
    "Conpherence Notifications" => "会话通知",
    "View All Conpherences" => "查看所有会话",
    ...
    "Another user already has this email." => "这个 Email 地址已被使用",
    "New Address" => "新地址",
    ...
    "You can not post an empty comment." => "评论内容必须填写",
    "This %s already has that view policy." => "此%s的可见权限没有改变",
    "This %s already has that edit policy." => "此%s的修改权限没有改变",
    "This %s already has that join policy." => "此%s的加入权限没有改变",
    "All users are already subscribed to this %s." => "所有用户已经关注此%s",
    ...
    "%s changed the visibility of this %s from \"%s\" to \"%s\"." => "%s 将此%s的可见权限从 \"%s\" 修改为了 \"%s\"",
    "%s changed the edit policy of this %s from \"%s\" to \"%s\"." => "%s 将此%s的修改权限从 \"%s\" 修改为了 \"%s\"",
    "%s changed the join policy of this %s from \"%s\" to \"%s\"." => "%s 将此%s的加入权限从 \"%s\" 修改为了 \"%s\"",
    "%s edited subscriber(s), added %d: %s; removed %d: %s." => "%s 抄送给了 %d 个人 %s，移除了 %d 个关注人 %s",
    "%s added %d subscriber(s): %s." => "%s 抄送给了 %d 个人 %s",
    "%s removed %d subscriber(s): %s." => "%s 取消抄送了 %d 个人 %s",
    "%s updated subscribers..." => "%s 更新了关注...",
    "%s edited edge metadata." => "%s edited edge metadata.",
    "%s edited a custom field." => "%s edited a custom field.",
    "%s edited this %s." => "%s 编辑了此 %s",
    "%s added a comment to %s." => "%s 评论了 %s",
    "%s changed the visibility for %s." => "%s 修改了 %s 的可见权限",
    "%s changed the edit policy for %s." => "%s 修改了 %s 的编辑权限",
    "%s changed the join policy for %s." => "%s 修改了 %s 的加入权限",
    "%s updated subscribers of %s." => "%s 更新了 %s 的关注人",
    ...
    "Saved Draft" => "已保存的草稿",
    "(Show Details)" => "(显示详情)",
    "This comment has been deleted." => "评论已删除",
    ...
    "PREVIEW" => "预览",
    "%s older changes(s) are hidden." => "%s 更早的改动已隐藏",
    "Show all changes." => "显示所有改动",
    "D, M j" => "D(m月j日)",
    "M j Y" => "Y年m月j日",
    "g:i A" => "H:i:s",
    "Press %s to show keyboard shortcuts." => "按下 %s 即可显示键盘快捷键",
    "You can also upload files by dragging and dropping them from your desktop onto this page or the Phabricator home page.", "拖拉文件到浏览器窗口即可上传",
